...
<td>
    <div class="hstack gap-3 flex-wrap">
        ...
        <x-permission name="events-delete">
            <a href="{{ route('admin.events.destroy' , $event->id) }}" data-id="{{ $event->id }}" class="text-danger d-inline-block remove-item-btn item-delete" ><i class="ri-delete-bin-5-fill fs-16"></i></a>
        </x-permission>
