<td>
    <div class="hstack gap-3 flex-wrap">
        <x-permission name="admins-update">
            <a href="{{ route('admin.admins.edit' , $id) }}" class="link-success fs-15 icon1"><i class="ri-edit-2-line"></i></a>
        </x-permission>
...
<x-destroy id="deleteRecordModal{{ $id }}" route="{{ route('admin.admins.destroy' , $id) }}" :value="$admin->name"/>
