                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Trust Fx Brokers . Crafted with <i class="mdi mdi-heart text-danger"></i> <a href="https://tek-part.com/" target="blank">Tek part Solution</a>
                            </p>
                        </div>
                    </div>
                </div>
