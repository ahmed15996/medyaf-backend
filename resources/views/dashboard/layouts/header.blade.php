                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light-subtle text-body fs-13"> 3 New</span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <a href="{{ route('admin.product-details' , $notification->id) }}" class="stretched-link">
                                                            <h6 class="mt-0 mb-1 fs-13 fw-semibold">{{ $notification->product->name }}</h6>
                                                        </a>
                                                        <div class="fs-13 text-muted">
                                                            <p class="mb-1">{{ $notification->desc }} 🔔.</p>
                                                        </div>
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                            <span><i class="mdi mdi-clock-outline"></i> {{ $notification->created_at->diffForHumans() }} min ago</span>
                                                        </p>
                                                    </div>
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown "
                        ...
                        <span class="d-flex align-items-center ">
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('storage/' . auth('admin')->user()->img) }}" alt="Header Avatar">
